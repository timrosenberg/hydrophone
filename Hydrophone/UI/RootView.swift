    ...
    var body: some View {
        ...
        .toolbar {
            ...
            ToolbarItem(placement: .principal) {
                // The app-wide library-load status (issue #102) lives inside
                // NowPlayingDisplay itself, as a leading segment sharing its
                // LCD capsule — see NowPlayingToolbar.swift.
                NowPlayingDisplay()
            }
